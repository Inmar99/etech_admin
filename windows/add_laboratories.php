    ...
    <div class="modal-dialog modal-sm" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="registro" onsubmit="return createLaboratories()">
                    <div class="form-row">
                        ...
                        <div class="form-group col-md-12">
                            ...
                            <input type="text" class="form-control form-control-sm" id="nombre" name="nombre" placeholder="Lab. Rosales" required>
                        </div>

                        <div class="form-group col-md-12">
                            <label for="nombre">Descripcion</label> 
                            <input type="textarea" class="form-control form-control-sm" id="descripcion" name="descripcion" placeholder="Una pequeña descripción del laboratorio">
                        </div>
