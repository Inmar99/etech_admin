             ...
             EOD;
                ...
                while ($dataProd = mysqli_fetch_array($resProduct)) {
                  ...
                  /*   $pdf->writeHTML($encabezado_subgrupo, true, false, false, false, ''); */
                    ...
                    $productsPresentations = "SELECT NAME as name, factor, sale_price FROM products_presentations WHERE id_product  = $id_prod ORDER BY FIELD(name,'CAJA','BLISTER','UNIDAD')";
                    ...
                    if($row_cnt >0){
                        ...
                        <table cellspacing="0" cellpadding="2" border="0">
                            <tr>
                                ...
                                <td width="90"></td>
                                <th width="250"></th>
                                <th width="558"><strong>PRESENTACIONES</strong> DEL PRODUCTO: $name_prod</th>
                                <th width="1"></th>
                                <td width="1"></td>
                                <td width="1"></td>
                                <th width="80"></th>
                    ...
                    $productsLotes = "SELECT lot, cant, date_lote, date_expiration FROM products_lot  WHERE id_produt = $id_prod";
                    $resProductLotes = mysqli_query($conexion, $productsLotes);
                    $row_cnt = $resProductLotes->num_rows;
                    ...
                    if($row_cnt >0){
                        ...
                        <table cellspacing="0" cellpadding="2" border="0">
                            ...
                            <tr>
                                ...
                                <td width="90"></td>
                                <th width="250"></th>
                                <th width="558"><strong>LOTES</strong> CORRESPONDIENTES DEL PRODUCTO: $name_prod</th>
                                <th width="1"></th>
                                <td width="1"></td>
                                <td width="1"></td>
                                <th width="80"></th>
                            ...
                            <tr>
                                ...
                                <td width="90"></td>
                                <th width="250"></th>
                                <th width="140"><strong>Numero Lote.</strong></th>
                                <th width="120"><strong>Fecha Vencimiento</strong></th>
                                <td width="180"><strong>Fecha Especifica</strong></td>
                                <td width="70"><strong></strong></td>
                                <th width="80"></th>
                            </tr>
                        EOD;

                        while ($dataProdLotes = mysqli_fetch_array($resProductLotes)) {
                            $lote = strtoupper($dataProdLotes['lot']);
                            $cantidad = strtoupper($dataProdLotes['cant']);
                            $fechaVence = strtoupper($dataProdLotes['date_expiration']);
                            $fecha = obtenerFechaEnLetra($fechaVence);
                            ...
                            $tbl_head .= <<<EOD
                                <tr>
                                    ...
                                    <td width="90"></td>
                                    <td width="250"></td>
                                    <td width="140">$lote</td>
                                    <td width="120">$fechaVence</td>
                                    <td width="180"><strong>$fecha</strong></td>
                                    <td width="70"></td>
                                    <th width="80"></th>
                                </tr>
                            EOD; 
