...
<div class="card">
    ...
    <div class="card-header border-0">
        <div class="row">
            <div class="col-6">
                <h3 class="mb-0">Listado de Laboratorios</h3>
                <input type="hidden" name="table_name" id="table_name" value="products_laboratories">
...
<?php
  ...
  require_once ('../../windows/add_laboratories.php');
